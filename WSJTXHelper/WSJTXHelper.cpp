...
// WSJTXHelper.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CWSJTXHelperApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CWSJTXHelperApp

CWSJTXHelperApp::CWSJTXHelperApp()
{
...
// Seul et unique objet CWSJTXHelperApp

CWSJTXHelperApp theApp;


// initialisation de CWSJTXHelperApp

BOOL CWSJTXHelperApp::InitInstance()
{
